...
class Parameters():
    ...
    regression_size = 110
    mode = 2
    threshold_point = 0.9 #0.35 #0.5 #0.57 #0.64 #0.35
    ...
    img_root= 'C:/D/002_DeepLearning/crossLane/first/test/data/image/'
    video_root= 'C:/D/002_DeepLearning/crossLane/first/test/data/video/'
    # video_root= 'C:/D/002_DeepLearning/crossLane/demo/example/videos/'
